                    ...
                    <form action="{{ route('authors.update', $author->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{ asset($author->image) }}" alt="{{ $author->name }}" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
                            </div>
                            @endif
                            ...
                            <div class="form-text">Supported formats: JPEG, PNG, JPG, GIF. Max size: 2MB. Leave empty to keep current photo.</div>
                            @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
